		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapdemomanagecustomermanagecustomer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdemomanagecustomermanagecustomer-display": {
								"semanticObject": "comsapdemomanagecustomermanagecustomer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.demo.managecustomer.managecustomer",
									"url": sap.ui.require.toUrl("com/sap/demo/managecustomer/managecustomer")
								}
							}
						}
					}
